...
public class SpriteAnimator : MonoBehaviour
{
    ...
    public bool PlayAnimationOnGameStart = false;
    ...
    void Awake()
    {
        ...
        //Connect Delegete with pointer
        if (PlayAnimationOnGameStart)
        {
    ...
    void OnEnable()
    {
        if (playAnimationOnStart != "" && !PlayAnimationOnGameStart)
        {
    ...
    public void ForcePlay(string name, bool loop = true, int startFrame = 0, AudioClip soundToPlay = null)
    {
        Animation animation = GetAnimation(name);
        if (animation != null)
        {
